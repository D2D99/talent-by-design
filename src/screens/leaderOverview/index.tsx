...
const LeaderOverview = () => {
  ...
  const roleData = [roleBreakdown?.manager || 0, roleBreakdown?.employee || 0];
            ...
            <div className="flex items-center gap-3">
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  {department || "Department"} Hub · Q{selectedQuarter}{" "}
                  {selectedYear}
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3">
          {[
            ...
            },
            {
              ...
              value: completionRate >= 50 ? "Stable" : "Developing",
        ...
        <div className="bg-[var(--app-surface)] rounded-[24px] border border-[var(--app-border-color)] p-8 flex flex-col gap-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">
                POD Insights™ Leader Intelligence
              </p>
            </div>
