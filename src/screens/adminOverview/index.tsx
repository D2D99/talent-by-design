    ...
    <div className="sm:p-6 p-3 space-y-6 max-w-[1600px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="bg-[var(--app-surface)] border border-[var(--app-border-color)] shadow-[0_8px_30px_rgba(68,140,210,0.08)] sm:p-8 p-5 rounded-[20px]">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-3xl font-black text-[var(--app-heading-color)] tracking-tight">
                Team Intelligence
              </h1>
              <div className="flex items-center gap-2 mt-1">
                <span className="w-2 h-2 rounded-full bg-[#10B981] animate-pulse"></span>
                <p className="text-sm font-bold text-[var(--app-text-muted)] uppercase tracking-wider">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {displayStats.map((stat: any, idx: number) => (
          <div
            key={idx}
            className="bg-[var(--app-surface)] p-6 rounded-[20px] border border-[var(--app-border-color)] shadow-sm group hover:border-[var(--primary-color)] transition-all duration-300"
          >
