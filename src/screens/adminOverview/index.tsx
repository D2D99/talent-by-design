        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
          ...
          <div className="xl:col-span-4 flex flex-col gap-4">
            <div className="flex-1 bg-[var(--app-surface)] rounded-[20px] border border-[var(--app-border-color)] p-7 flex flex-col items-center justify-center text-center shadow-sm relative overflow-hidden group">
              ...
              <h3 className="text-[11px] font-black text-[var(--app-heading-color)] uppercase tracking-[0.2em] mb-6">Overall Health</h3>
            ...
            >
              <div className="text-left relative z-10">
                <p className="text-[9px] font-black text-blue-200/80 uppercase tracking-[0.2em] mb-1">Governance Module</p>
                <h4 className="text-base font-black tracking-wide">Audit Assessments</h4>
              </div>
        ...
        <div className="bg-[var(--app-surface-soft)] rounded-[20px] border border-[var(--app-border-color)] p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">POD Insights™ Engine Intelligence</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-[#448CD2] to-[#1a3652] rounded-[24px] p-8 text-white relative overflow-hidden shadow-2xl group">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
            <div className="flex items-center gap-8">
              ...
              <div>
                <h2 className="text-2xl font-black tracking-tight leading-none mb-2">Strategic Insight</h2>
                <p className="text-sm text-blue-100/80 font-medium max-w-md leading-relaxed">
                  Excellent engagement! Your organization shows strong <strong className="text-white">'Strategic Alignment'</strong>. {intelData?.strategicInsight || "Results indicate high readiness for growth."}
                </p>
              </div>
            </div>
