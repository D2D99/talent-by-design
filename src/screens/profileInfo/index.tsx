            ...
            <div className="sm:mb-4 mb-2">
              ...
              <div className="relative w-full">
                <input
                  ...
                  id="role"
                  readOnly
                  className="font-medium text-sm text-[#5D5D5D] capitalize w-full p-3 mt-2 border rounded-lg transition-all outline-none border-[#E8E8E8] bg-neutral-100 cursor-not-allowed read-only:bg-gray-50"
