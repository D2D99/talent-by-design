...
const WwoImg1 = "/static/img/wwo-img1.png";
        ...
        <div className="max-w-screen-2xl mx-auto xl:px-10 px-4 relative z-10">
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
            ...
            <div className="lg:w-5/12 lg:sticky lg:top-32">
              ...
              <div className="mt-8 border-l-4 border-[var(--primary-color)] pl-5">
                <p className="text-base font-medium text-[var(--secondary-color)] leading-relaxed">
                  This is the make-or-break moment when employees are adjusting
                  to new ways of working, leaders need visibility into adoption,
                  and the business expects to see measurable outcomes.
                </p>
              </div>
            </div>
            ...
            <div className="lg:w-7/12">
              <h3 className="text-2xl font-bold text-[var(--dark-primary-color)] mb-5 tracking-tight capitalize">
                Organizations invest heavily in change, but want to know:
              </h3>
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  {
                    q: "Are employees adopting the change?",
                    i: "solar:users-group-rounded-linear",
                  },
                  {
                    q: "Are teams confident and capable in the new way of working?",
                    i: "solar:shield-check-linear",
                  },
                  {
                    q: "Are operational processes stabilizing?",
                    i: "solar:settings-linear",
                  },
                  {
                    q: "Are intended benefits being realized?",
                    i: "solar:chart-square-linear",
                  },
                  {
                    q: "Where are risks, resistance, or gaps emerging?",
                    i: "solar:danger-triangle-linear",
                  },
                  {
                    q: "What actions are needed to protect the investment?",
                    i: "solar:shield-keyhole-linear",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="bg-white rounded-2xl p-6 shadow-[0_8px_40px_rgb(0,0,0,0.06)] border border-slate-100 flex flex-col gap-5"
                  >
        ...
        <div className="max-w-screen-2xl mx-auto xl:px-10 px-4">
          <div className="mb-16 text-center max-w-3xl mx-auto">
            ...
            <h2 className="sub-heading !mx-auto">
              Our Service{" "}
              <span className="sub-heading-highlight">Offerings</span>
            </h2>
            <p className="text-base font-normal mt-3 text-[var(--secondary-color)]">
              Structured pulse assessments, benefits tracking, insight
              reporting, and targeted change management support for up to 24
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-8">
            ...
            <div className="home-step-card group shadow-[4px_4px_15px_0_rgba(68,140,210,0.05)] transition-all duration-300 border border-[rgba(68,140,210,0.2)] sm:p-8 p-6 bg-white rounded-2xl flex flex-col h-full relative overflow-hidden">
              <img
                src={Number1}
                className="w-20 absolute top-6 right-6 opacity-80 transition-transform duration-500"
                alt="Number 1"
              />
              ...
              <div className="w-3/4">
                ...
                <p className="text-base font-normal mt-1 text-[var(--secondary-color)]">
                  ...
                  of how change is landing across the organization.
                </p>
              </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    ...
                    <span className="text-sm text-[var(--secondary-color)]">
                      <strong className="text-[var(--dark-primary-color)]">
                        People Potential:
                      </strong>{" "}
                      Feeling, adapting, and engaging.
                    </span>
                  </li>
                  <li className="flex items-start gap-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    <img
                    ...
                    <span className="text-sm text-[var(--secondary-color)]">
                      ...
                      Clarity of processes & expectations.
                    </span>
                  </li>
                  <li className="flex items-start gap-2 bg-slate-50 p-3 rounded-lg border border-slate-100">
                    <img
                    ...
                    <span className="text-sm text-[var(--secondary-color)]">
                      ...
                      Confidence in using new tools & data.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-auto pt-5 border-t border-[var(--app-border-color)]">
                <strong className="text-[var(--primary-color)] uppercase text-[11px] tracking-widest block mb-1">
                  Best For:
                </strong>
                <span className="text-sm font-medium text-[var(--secondary-color)] leading-snug block">
                  Post-go-live health checks, adoption reviews, leadership
                  reporting, and early identification of change risks.
                </span>
              </div>
            </div>
            ...
            <div className="home-step-card group shadow-[4px_4px_15px_0_rgba(68,140,210,0.05)] transition-all duration-300 border border-[rgba(68,140,210,0.2)] sm:p-8 p-6 bg-white rounded-2xl flex flex-col h-full relative overflow-hidden">
              ...
              <div className="w-3/4">
                ...
                <p className="text-base font-normal mt-1 text-[var(--secondary-color)]">
                  Establish a clear baseline for tracking whether expected
                  outcomes are being realized after implementation.
                </p>
              </div>
              ...
              <div className="mt-6 mb-6">
                ...
                <div className="bg-[var(--primary-color)]/5 p-5 rounded-xl border border-[var(--primary-color)]/10">
                  ...
                  <p className="text-sm font-medium text-[var(--secondary-color)] mt-3 leading-relaxed">
                    Understand whether you are on track to achieve outcomes from
                    the business case or project charter.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-auto pt-5 border-t border-[var(--app-border-color)]">
                ...
                <span className="text-sm font-medium text-[var(--secondary-color)] leading-snug block">
                  Organizations moving from project delivery reporting to
            ...
            <div className="home-step-card group shadow-[4px_4px_15px_0_rgba(68,140,210,0.05)] transition-all duration-300 border border-[rgba(68,140,210,0.2)] sm:p-8 p-6 bg-white rounded-2xl flex flex-col h-full relative overflow-hidden">
              ...
              <div className="w-3/4">
                ...
                <p className="text-base font-normal mt-1 text-[var(--secondary-color)]">
                  Ongoing pulse assessments and change management support over a
                  defined sustainment period.
                </p>
              </div>
              ...
              <div className="mt-6 mb-6">
                <div className="bg-slate-50 border-l-4 border-[var(--primary-color)] p-5 rounded-r-xl">
                  <p className="text-sm font-medium text-[var(--secondary-color)] leading-relaxed italic">
                    "Rather than relying on a single post-go-live survey, this
                    offering tracks change over time."
                  </p>
                </div>
                <p className="text-sm font-medium text-[var(--secondary-color)] leading-relaxed mt-4">
                  Helps leaders see whether adoption is improving, whether
                  confidence is increasing, and whether operational issues are
                  being resolved or repeated. Each pulse provides insight into
                  what is working and what actions are needed next.
                </p>
              </div>
              ...
              <div className="mt-auto pt-5 border-t border-[var(--app-border-color)]">
                ...
                <span className="text-sm font-medium text-[var(--secondary-color)] leading-snug block">
                  Organizations that want structured support for 6 to 12 months
                  after go-live.
                </span>
              </div>
            </div>
            ...
            <div className="home-step-card group shadow-[4px_4px_15px_0_rgba(68,140,210,0.05)] transition-all duration-300 border border-[var(--primary-color)] sm:p-8 p-6 bg-white rounded-2xl flex flex-col h-full relative overflow-hidden">
              <div className="absolute top-0 right-0 bg-[var(--primary-color)] text-white text-[10px] font-bold px-4 py-1.5 rounded-bl-xl uppercase tracking-widest">
                Comprehensive
              </div>
              <img
                src={Number4}
                className="w-20 absolute top-8 right-6 opacity-80 transition-transform duration-500"
                alt="Number 4"
              />
              ...
              <div className="w-3/4 mt-2">
                ...
                <p className="text-base font-normal mt-1 text-[var(--secondary-color)]">
                  Our most comprehensive offering supports organizations for up
                  to 24 months post go-live.
                </p>
              </div>
              ...
              <div className="mt-auto pt-5 border-t border-[var(--primary-color)]/20 bg-[var(--light-primary-color)] -mx-6 -mb-6 px-6 pb-6 pt-5 rounded-b-2xl">
                ...
                <span className="text-sm font-medium text-[var(--dark-primary-color)] leading-snug block">
                  Enterprise tech implementations, multi-phase transformation
                  programs, operating model changes, and initiatives with
        ...
        <div className="max-w-screen-2xl mx-auto xl:px-10 px-4 space-y-24">
          ...
          <div className="grid lg:grid-cols-2  grid-cols-1 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-base font-normal sm:mt-2 mt-3 text-[var(--secondary-color)]">
                It is a proprietary software-enabled solution designed
                specifically to help organizations measure and sustain change
                after go-live.
              </p>
              <div className="mt-8 border-l-4 border-[var(--primary-color)] pl-6">
                <p className="text-base font-medium text-[var(--dark-primary-color)] italic">
                  "We combine structured employee pulse data, benefits
                  realization thinking, and practical change management
                  expertise to help leaders answer the question that matters
                  most: Is this change actually working?"
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 grid-cols-1 gap-12 items-center">
            <div>
              ...
              <h2 className="sub-heading">
                Value <span className="sub-heading-highlight">Realized</span>{" "}
                After Go-Live
              </h2>
              ...
              <p className="text-base font-normal mt-4 text-[var(--secondary-color)] leading-relaxed">
                Many organizations invest heavily in new systems, processes, and
                transformation initiatives, only to shift attention to the next
                priority once go-live is complete. But the true value of change
                is realized after implementation — when people begin using the
                new tools, following new processes, and embedding new behaviours
                into daily work.
              </p>
              ...
              <p className="text-base font-normal mt-2 text-[var(--secondary-color)] leading-relaxed">
                We help leaders see what is happening beneath the surface,
                respond to emerging risks, and take action before adoption
                issues become long-term sustainment problems.
              </p>
            </div>
      ...
      <div className="relative py-24 overflow-hidden z-0 bg-slate-50/50">
        <div className="max-w-screen-2xl mx-auto xl:px-10 px-4 relative z-10">
          <div className="mb-16 text-center">
            <h4 className="badge mb-5">WHO WE SUPPORT</h4>
            <h2 className="sub-heading !mx-auto">
              Initiatives We{" "}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            {[
              {
                t: "Large-Scale Transformation",
                d: "Enterprise-wide strategy execution and culture shifts.",
                i: "solar:global-linear",
                span: "md:col-span-2 md:row-span-2",
              },
              {
                t: "Digital Initiatives",
                d: "Guiding people through sweeping digital changes.",
                i: "solar:rocket-linear",
                span: "md:col-span-2",
              },
              {
                t: "ERP, CRM & HRIS",
                d: "Maximizing ROI on complex enterprise systems.",
                i: "solar:database-linear",
                span: "md:col-span-2",
              },
              {
                t: "M365 & Workspace Rollouts",
                d: "Driving collaboration and workplace productivity.",
                i: "solar:users-group-two-rounded-linear",
                span: "md:col-span-2",
              },
              {
                t: "Operating Model Changes",
                d: "Aligning teams to new operational standards.",
                i: "solar:branching-paths-up-linear",
                span: "md:col-span-2 md:row-span-2",
              },
              {
                t: "New Tech Platforms",
                d: "Ensuring seamless adoption of critical software.",
                i: "solar:laptop-minimalistic-linear",
                span: "md:col-span-2",
              },
            ].map((item, i) => (
              <div
                key={i}
                className={`relative bg-white p-5 rounded-3xl border border-slate-100 shadow-[0_8px_40px_rgb(0,0,0,0.06)] flex flex-col overflow-hidden ${item.span}`}
              >
                {/* Massive subtle watermark icon */}
                <Icon
                  icon={item.i}
                  className="absolute -right-6 -bottom-6 size-48 text-slate-50 rotate-[-15deg] pointer-events-none"
                />

                <div className="w-14 h-14 rounded-2xl bg-[var(--light-primary-color)]/30 flex items-center justify-center mb-8 relative z-10">
                  <Icon
                    icon={item.i}
                    className="size-10 text-[var(--dark-primary-color)]"
                  />
                </div>

                <div className="mt-auto relative z-10">
                  <h3 className="text-xl font-bold text-[var(--dark-primary-color)] mb-1">
                    {item.t}
                  </h3>
                  <p className="text-sm font-medium text-[var(--secondary-color)] leading-relaxed">
                    {item.d}
          ...
          <div className="relative mt-5 mx-auto text-center">
            <div className="bg-[var(--dark-primary-color)] p-10 rounded-3xl mt-5 border border-[var(--primary-color)]/20 shadow-lg relative z-10 text-white">
              <h4 className="badge !text-xs !text-white">THE OUTCOME</h4>
              <h3 className="text-xl max-w-lg capitalize mx-auto font-medium text-[var(--white-color)]">
                Protect your investment, support your people, and prove the
