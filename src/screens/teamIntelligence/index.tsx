...
const TeamIntelligence = () => {
  ...
  useEffect(() => {
    const fetchIntelligence = async () => {
      try {
        let url = `assessment/admin/intelligence?quarter=${selectedQuarter}&year=${selectedYear}`;
        if (user?.role?.toLowerCase() === "leader") {
          url = `assessment/leader/intelligence?quarter=${selectedQuarter}&year=${selectedYear}`;
        } else if (user?.role?.toLowerCase() === "manager") {
          url = `assessment/manager/intelligence?quarter=${selectedQuarter}&year=${selectedYear}`;
        }
