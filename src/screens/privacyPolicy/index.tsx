...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          This Privacy Policy applies to personal information we collect from or
          about:
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Depending on how the Services are used, we may collect the following
        ...
        <h3 className="font-semibold text-slate-800 mt-6 text-lg">
        ...
        <p className="mt-2">
          Clients may provide organizational information to support assessment
          setup and reporting, such as:
        </p>
        <ul className="list-disc pl-5 mt-2 space-y-1">
        ...
        <p className="mt-4">
          Clients should avoid uploading unnecessary personal information or
          sensitive personal information unless it is required and authorized.
        </p>
        <h3 className="font-semibold text-slate-800 mt-6 text-lg">
        ...
        <p className="mt-2">
          If you contact us, we may collect information included in your
          message, inquiry, support request, meeting notes, or feedback.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          ...
          about themselves or others in open-text responses unless specifically
          requested and clearly appropriate.
        </p>
        <p className="mt-4">
          Client organizations are responsible for ensuring assessment
          questions, participant communications, and uploaded materials are
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1">
          ...
          <li>
            Generate dashboards, reports, summaries, insights, and
            recommendations;
          </li>
          <li>
            Analyze assessment results by organization, role, stakeholder group,
            project, program, or assessment checkpoint;
          </li>
          <li>
            Support change management, benefits realization, organizational
            effectiveness, and leadership planning;
          </li>
          <li>Provide customer support;</li>
          <li>
            Improve platform functionality, scoring, reporting, and user
            experience;
          </li>
          ...
          <li>
            Meet legal, regulatory, contractual, accounting, or security
            obligations.
          </li>
        </ul>
      </>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          AI-enabled outputs are intended to support human review and
          decision-making. They should not be used as the sole basis for
          decisions that may significantly affect an individual.
        </p>
        <p className="mt-4">
          Where AI features are used, personal information may be processed to
          generate insights unless the feature is configured to use aggregated,
          de-identified, or limited data.
        </p>
        <p className="mt-4">
          We aim to apply reasonable safeguards and data minimization practices
          when using AI-enabled features.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          We collect, use, and disclose personal information with consent or as
          otherwise permitted or required by applicable law.
        </p>
        <p className="mt-4">
          Consent may be provided directly by an individual, through
          participation in an assessment, through account registration, through
          communications with us, or through a client organization where
          appropriate.
        </p>
        <p className="mt-4">
          Before completing an assessment, participants should be informed of
          the purpose of the assessment, how results will be used, who may
          access reports, and whether results will be reported individually, by
          group, or in aggregated form.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          Where possible, reports are designed to support organizational insight
          rather than individual monitoring. We encourage clients to use minimum
          group-size thresholds, aggregation, and de-identification where
          appropriate.
        </p>
        <p className="mt-4">
          Open-text comments may be summarized, themed, edited, or displayed in
          reports. Participants should not include names or identifying details
          about others in open-text responses.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-1">
          <li>
            The client organization that invited users to complete an
            assessment;
          </li>
          <li>
            Authorized administrators, leaders, consultants, or project team
            members designated by the client;
          </li>
          <li>
            Service providers who help us host, operate, secure, support,
            analyze, or improve the Services;
          </li>
          <li>
            Professional advisors, such as lawyers, accountants, insurers, or
            auditors;
          </li>
          <li>
            Government, regulatory, law enforcement, or legal authorities where
            required or permitted by law;
          </li>
          <li>
            A successor organization in connection with a merger, acquisition,
            financing, restructuring, or sale of business assets, subject to
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          We may use service providers located in Canada or other jurisdictions.
          Personal information may be stored or processed outside the province
          or country where the individual resides.
        </p>
        <p className="mt-4">
          Where personal information is processed outside Canada, it may be
          subject to the laws of that jurisdiction. We use contractual,
          technical, and organizational safeguards intended to protect personal
          information handled by service providers.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          for the purposes described in this Privacy Policy, to provide the
          Services, to meet client agreement requirements, to comply with legal
          or accounting obligations, to resolve disputes, and to maintain
          security records.
        </p>
        <p className="mt-4">
          Retention periods may vary depending on the client agreement, type of
          data, legal requirements, and operational needs.
        </p>
        <p className="mt-4">
          When personal information is no longer required, we will delete,
          anonymize, de-identify, or securely dispose of it, subject to legal
    ...
    content: (
      <>
        <p>
          ...
          use, disclosure, alteration, loss, or destruction.
        </p>
        <p className="mt-4">
          Safeguards may include access controls, authentication, encryption
          where appropriate, audit logging, secure hosting practices,
          confidentiality obligations, and role-based access.
        </p>
        <p className="mt-4">
          No system can be guaranteed to be completely secure. Users are
          responsible for protecting account credentials and notifying us
    ...
    content: (
      <>
        <p>
          ...
          support authentication, remember preferences, improve functionality,
          analyze usage, and maintain security.
        </p>
        <p className="mt-4">
          Users may adjust browser settings to block or delete cookies, but some
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Individuals may request access to or correction of their personal
        ...
        <p className="mt-4">
          Requests may be sent to the contact listed below.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Where we rely on consent, individuals may withdraw consent, subject to
          legal or contractual restrictions and reasonable notice.
        </p>
        <p className="mt-4">
          Withdrawing consent may limit access to certain Services or prevent
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Individuals may contact us with privacy questions, access requests,
          correction requests, or complaints.
        </p>
        <p className="mt-4">
          We will review privacy complaints and respond within a reasonable
          time. If we cannot resolve a concern, individuals may have the right
          to contact the applicable privacy commissioner or regulatory
          authority.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          The Services are intended for organizational and professional use and
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-4">
          For material changes, we may provide additional notice where
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mt-2">
          <strong>Privacy Officer:</strong> Suzanna de Souza
        </p>
        <p className="mt-2">
        ...
        <p className="mt-2">
          <strong>Phone:</strong> +1-604-785-8966
        </p>
      </>
    ),
  },
        ...
        <section className="max-w-7xl mx-auto px-4 py-12 md:py-20 flex flex-col md:flex-row gap-12 lg:gap-20 relative">
          ...
          <aside className="w-full md:w-1/4 lg:w-1/5 flex-shrink-0">
            <div className="md:sticky md:top-32 space-y-1 relative z-20">
              ...
              <div
                className="hidden md:block relative overflow-y-auto pr-4"
          ...
          <main className="w-full md:w-3/4 lg:w-3/5">
            <div className="prose prose-slate prose-lg max-w-none">
              ...
              <div className="text-slate-600 mb-16 leading-relaxed text-base">
                ...
                <p className="mt-4">
                  We are committed to protecting personal information and using
                  it responsibly, transparently, and only for appropriate
                  purposes.
                </p>
              </div>
