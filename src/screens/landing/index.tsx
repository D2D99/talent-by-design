    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto text-center px-4">
          ...
          <h1 className="mt-5 max-w-4xl mx-auto xl:text-6xl md:text-5xl text-4xl  font-bold text-[var(--dark-primary-color)] uppercase">
            Clarity for Leaders. Stability for Teams. Readiness for the Future.
          </h1>
          <p className="sm:text-xl text-base text-[var(--dark-primary-color)] font-medium mt-2.5 sm:mb-10 mb-5   ">
          ...
          <div className="flex justify-center sm:flex-nowrap flex-wrap gap-5">
            <button
              type="button"
              className="group text-white rounded-full py-2.5 pl-7 pr-3.5 flex items-center gap-1.5 font-semibold sm:text-lg text-base uppercase 
      ...
      <div className="lg:pt-28  md:pt-20 pt-12 pb-12 md:pb-20">
        <div className="max-w-screen-2xl mx-auto xl:px-10 px-4">
          ...
          <h2 className="sm:text-4xl text-3xl text-[var(--secondary-color)] font-light max-w-md mt-4">
            Data Highlights{" "}
          ...
          <ul className="mt-7">
            <li className="flex sm:items-center items-start gap-2.5  sm:text-lg text-[var(--secondary-color)]">
            ...
            <li className="flex items-start gap-2.5  sm:text-lg text-[var(--secondary-color)] mt-2">
              <img src={IconStar} alt="icon" />{" "}
              <span>
          ...
          <h5 className="sm:text-xl text-lg text-[var(--secondary-color)] sm:mt-10 mt-5 font-semibold">
          ...
          <div className="lg:grid lg:grid-cols-2 grid-cols-2 lg:justify-between lg:gap-3">
            ...
            <div>
              <div className="grid md:grid-cols-2 grid-cols-1 md:gap-x-6 md:gap-y-0 gap-y-5 lg:mt-0 mt-7 ">
                <div className="grid-rows-1 md:sticky relative md:top-28 z-[1] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mb-8">
                ...
                <div className="md:invisible visible grid-rows-2 md:sticky relative md:top-28 z-[1] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mt-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    02
                  </h2> */}
                  <img
                ...
                <div className="md:block hidden invisible grid-rows-1 md:sticky relative md:top-28 z-[1] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mb-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    01
                  </h2> */}
                  <img
                ...
                <div className=" md:block hidden grid-rows-2 md:sticky relative md:top-28 z-[1] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mt-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    02
                  </h2> */}
                  <img
                ...
                <div className="grid-rows-2 md:sticky relative md:top-36 z-[2] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mb-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    03
                  </h2> */}
                  <img
                ...
                <div className="md:invisible visible grid-rows-4 md:sticky relative md:top-36 z-[2] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mt-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    04
                  </h2> */}
                  <img
                ...
                <div className="invisible md:block hidden grid-rows-2 md:sticky relative md:top-36 z-[2] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mb-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    03
                  </h2> */}
                  <img
                ...
                <div className="grid-rows-4 md:block hidden md:sticky relative md:top-36 z-[2] shadow-[4px_4px_4px_0_rgba(68,140,210,0.1)] border border-[rgba(68,140,210,0.2)] sm:p-6 p-4 bg-white rounded-xl md:mt-8">
                  {/* <h2 className="mb-4 text-7xl font-bold text-transparent [-webkit-text-stroke:3px_#3b73b9] text-right">
                    04
                  </h2> */}
                  <img
          ...
          <div className="flex items-center justify-center ">
            <div className="flex gap-14">
              <div className="flex gap-5 items-center">
                ...
                <span className="text-[var(--white-color)] lg:text-4xl md:text-3xl font-medium">
