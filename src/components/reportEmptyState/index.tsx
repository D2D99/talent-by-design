...
const ReportEmptyState: React.FC<ReportEmptyStateProps> = ({ role }) => {
    return (
        <div className="p-12 text-center flex flex-col items-center mt-10">
            <div className="bg-[#448CD208] p-4 rounded-full shadow-sm mb-4">
                <Icon
                    icon="hugeicons:audit-02"
                    className="text-[var(--primary-color)] w-12 h-12"
                />
            </div>
            <h2 className="text-xl font-bold text-[#1A3652]">
                No {role} Selected
            </h2>
            <p className="text-gray-500 max-w-sm mt-3 text-sm leading-relaxed px-4">
