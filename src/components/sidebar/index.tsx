      ...
      <div>
        ...
        {user.role !== "superAdmin" && (
          <div className="flex items-center justify-center gap-y-2.5 xl:flex-row md:flex-col mb-12 flex-wrap">
            <img src={DashboardLogo} className="xl:max-w-28 max-w-24 logo" alt="Dashboard Logo" />
            <svg
            ...
            <img src={(user as any).orgLogo || DashboardLogo} className="xl:max-w-28 max-w-24 logo" alt="Logo" />
          </div>
        )}
